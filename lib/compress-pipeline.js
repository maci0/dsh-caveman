...
import { detectFileType, shouldCompress } from './compress-detect.js';
import { backupPathFor, backupDirFor, isSensitivePath, MAX_FILE_SIZE, readSource, withFileLock, writeBytesAtomic, writeTextAtomic, splitFrontmatter } from './compress-files.js';
import { compressBody, isSmaller } from './compress-rules.js';
import { validate } from './compress-validate.js';
/**
 ...
 */
export function compressFile(inputPath, maxFileSize = MAX_FILE_SIZE) {
...
function compressFileLocked(filePath) {
